...
public class WaveData {
    ...
    private WaveData(AudioInputStream stream) throws UnsupportedAudioFileException {
    ...
    public static WaveData create(String filename) throws UnsupportedAudioFileException, IOException{
